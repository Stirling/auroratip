module Tweet::Message
  ...
  module Invalid
    ...
    def unauthenticated(sender)
      link = "auroratip.auroracoin.io/auth/twitter?r=#{Helper.rand()}"
    ...
    def likely_forgot_symbol(sender)
      link = "auroratip.auroracoin.io/#/how-it-works?r=#{Helper.rand()}"
    ...
    def enough_confirmed_unspents(sender)
      link = "auroratip.auroracoin.io/#/account/deposit?r=#{Helper.rand()}"
      "@#{sender}, you don't have enough confirmed unspents, pls wait for a few mins! #{link}"
    end

    def min_output(sender)
      link = "auroratip.auroracoin.io/#/documentation?r=#{Helper.rand()}"
  ...
  module Pending
    ...
    def reminder(recipient, amount)
      link = "auroratip.auroracoin.io/#/profile/#{recipient}?direct=true"
